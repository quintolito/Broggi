  ...
  <div>
    ...
    >
      <form ref="form" @submit.stop.prevent="handleSubmit">
        ...
        >
          <b-form-input id="input-1" v-model="formAlertant.nom" required placeholder="Enter codi"></b-form-input>
        </b-form-group>

        <b-form-group id="input-group-2" label="adreca" label-for="input-2">
          <b-form-input id="input-2" v-model="formAlertant.adreca" required placeholder="Enter nom"></b-form-input>
        </b-form-group>
    ...
    >
      <form ref="form" @submit.stop.prevent="handleSubmit">
        <b-form-group
          ...
          description="We'll never share your email with anyone else."
        >
          <b-form-input id="input-1" v-model="form.codi" required placeholder="Enter codi"></b-form-input>
        </b-form-group>
...
export default {
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      axios
        .post("http://127.0.0.1:8000/api/" + this.tipoaccion, this.formAlertant)
